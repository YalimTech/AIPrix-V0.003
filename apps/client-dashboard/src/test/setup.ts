...
vi.mock('../components/modals/AgentWidgetModal', () => ({
  default: ({ isOpen, onClose, children }: { isOpen: boolean; onClose: () => void; children?: React.ReactNode }) => 
    isOpen ? React.createElement('div', { 'data-testid': 'agent-widget-modal' }, children) : null
}))

vi.mock('../components/modals/LaunchCallModal', () => ({
  default: ({ isOpen, onClose, onLaunch, agentId }: { isOpen: boolean; onClose: () => void; onLaunch: (phone: string) => void; agentId?: string }) => 
    isOpen ? React.createElement('div', { 'data-testid': 'launch-call-modal', 'data-agent-id': agentId }) : null
}))
