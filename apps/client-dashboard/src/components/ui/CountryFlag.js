 ...
 */
const CountryFlag = ({ countryCode, className = '', size = 'md' }) => {
    ...
    return (_jsx("span", { className: `inline-block ${sizeClasses[size]} ${className}`, role: "img", "aria-label": `Flag of ${countryCode}`, title: `Flag of ${countryCode}`, children: getFlagEmoji(countryCode) }));
};
