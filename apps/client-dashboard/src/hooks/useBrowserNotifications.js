...
export const useBrowserNotifications = () => {
    ...
    const showCallNotification = async (phoneNumber, direction, agentName) => {
    ...
    const showCampaignNotification = async (campaignName, status, stats) => {
    ...
    const showSystemNotification = async (type, title, message, actionUrl) => {
        const icons = {
    ...
    const showBillingNotification = async (type, amount) => {
        const notifications = {
            low_balance: {
                title: 'Balance bajo',
    ...
    const showIntegrationNotification = async (service, status, message) => {
