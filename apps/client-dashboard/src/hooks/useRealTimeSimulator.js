 ...
 */
export const useRealTimeSimulator = (enabled = false) => {
    ...
    useEffect(() => {
        ...
        if (!isWebSocketAvailable) {
            console.log("🎭 Simulador de tiempo real habilitado (solo en desarrollo)");
        }
        ...
        intervals.push(campaignInterval, callInterval, agentInterval, systemInterval);
        // Limpiar intervalos
        return () => {
