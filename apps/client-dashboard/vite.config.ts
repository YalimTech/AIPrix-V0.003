  ...
  return {
    ...
    define: {
      ...
      "import.meta.env.VITE_APP_URL": JSON.stringify(
        env.VITE_APP_URL || "https://agent.prixcenter.com",
      ),
      "import.meta.env.VITE_API_PROTOCOL": JSON.stringify(
        env.VITE_API_PROTOCOL || "https",
      ),
      "import.meta.env.VITE_API_HOST": JSON.stringify(
        env.VITE_API_HOST || "agent.prixcenter.com",
      ),
      "import.meta.env.VITE_API_PORT": JSON.stringify(
        env.VITE_API_PORT || "3004",
      ),
    },
    base: "/dashboard",
    server: {
        ...
        "/api": {
          ...
          configure: (proxy, _options) => {
            ...
            proxy.on("proxyReq", (_proxyReq, req, _res) => {
              console.log(
                "🔗 Client Dashboard Proxy Request:",
                req.method,
                req.url,
              );
            });
