...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        function PrismaService_1(configService) {
            ...
            var dbUrl = configService.get('database.url') || process.env.DATABASE_URL;
            ...
            _this.logger.log("\uD83D\uDD0D Database URL source: ".concat(configService.get('database.url') ? 'ConfigService' : 'process.env'));
            _this.logger.log("\uD83D\uDD0D Database URL configured: ".concat(dbUrl ? 'Yes' : 'No'));
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, this.$queryRaw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT 1 as test"], ["SELECT 1 as test"])))];
                        case 3:
                            _a.sent();
                        ...
                        case 4:
                            ...
                            this.logger.warn('⚠️ Verificación de conexión PostgreSQL falló:', verifyError_1.message);
                            return [3 /*break*/, 5];
                        case 5: return [3 /*break*/, 7];
                        case 6:
                            error_1 = _a.sent();
                            this.logger.error('❌ Error conectando a PostgreSQL:', error_1);
                            throw error_1;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_2 = _a.sent();
                            this.logger.error('❌ Error desconectando de la base de datos:', error_2);
                            return [3 /*break*/, 3];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.$queryRaw(templateObject_2 || (templateObject_2 = __makeTemplateObject(["SELECT 1"], ["SELECT 1"])))];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, true];
                        case 2:
                            error_3 = _a.sent();
                            this.logger.error('Health check falló:', error_3);
